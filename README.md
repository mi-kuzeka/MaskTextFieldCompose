...
You can use [**MaskVisualTransformation**](app/src/main/java/com/kuzepa/masktextfieldcompose/ui/utils/MaskVisualTransformation.kt) from this repository this way for **digits-only** input:
```kotlin
